...
:MainFuction
Echo Switching off Fan
Echo %keanu.date.time% User:%user% Switching off Fan >>%access.logs% 2>1&
REM mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "OFF" -t cmnd/107Fan/power
REM mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "OFF" -t stat/107Fan/POWER
mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "FAN" -t Keanu\Objects
mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "OFF" -t Keanu\Objects\FAN
goto :EOF
goto :successCheck
goto :Done
goto :Keanu
