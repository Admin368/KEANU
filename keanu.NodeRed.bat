...
set Question.Asked=Wuld you like to start Node-red?[Yes/No]
...
:MainFuction
REM starting node-red
REM start node-red >nul 2>nul
Echo opening nodered Port
start http://192.168.1.168:1880/

REM goto :successCheck
goto :Done
goto :FileStart
...
:Question.No
Echo There is nothing else to do in Process [%Process.Name%]
