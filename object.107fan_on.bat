...
@echo %Debug% 
Set Process.Name.Default=object.107fan_on.bat 
...
:MainFuction
Echo Switching on Fan
Echo %keanu.date.time% User:%user% Switching on Fan >>%access.logs% 2>1&
REM mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "ON" -t cmnd/107Fan/power
REM mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "ON" -t stat/107Fan/POWER
mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "FAN" -t Keanu\Objects
mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "ON" -t Keanu\Objects\FAN
