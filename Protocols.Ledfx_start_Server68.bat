...
@echo off 
Set Process.Name.Default=Protocols.Ledfx_start_Server68.bat 
...
:MainFuction
start /B mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "LEDFX" -t Keanu\Protocol
start /B mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "ON" -t Keanu\Protocol\LEDFX
set reply=Keanu Systeam starting visualization LEDFX on Ledfx_start_Server68
call reply.bat
timeout /t 3
start http:\\192.168.1.168:9292
call reply.bat
