...
start /B mosquitto_pub -h 192.168.1.100 -p 1883 -u mqtt -P mqtt -m "OFF" -t Keanu\Protocol\LEDFX
set reply=Keanu Systeam stoping visualization LEDFX on Ledfx_end_Server68
call reply.bat
timeout /t 3
call reply.bat
